...
To Upgrade to v1.3.1.1 from v1.3.1 follow the instructions listed below, 
 ...
 2. Update the latest images in docker-compose.yml. You can get the latest [docker-compose] (https://github.com/QIntegration/Qualys-Jira-Connector/blob/main/docker-compose.yml)
